...
public struct LocationNormalizer: Sendable {
    ...
    private static let entries: [Entry] = [
        ...
        Entry(aliases: ["chongqing", "重庆", "重慶"], city: "Chongqing", province: nil, tier: 2, score: 85),
        Entry(aliases: ["hangzhou", "杭州"], city: "Hangzhou", province: "Zhejiang", tier: 2, score: 85),
        Entry(aliases: ["suzhou", "苏州", "蘇州"], city: "Suzhou", province: "Jiangsu", tier: 2, score: 85),
        Entry(aliases: ["wuhan", "武汉", "武漢"], city: "Wuhan", province: "Hubei", tier: 3, score: 70),
        Entry(aliases: ["ningbo", "ninbo", "宁波", "寧波"], city: "Ningbo", province: "Zhejiang", tier: 3, score: 70),
